...
export function WAICard() {
    return(
        <div className="whoami wai-card-container p-12 w-full grid place-content-center h-screen sm:min-h-[40rem] min-h-[35rem] bg-gradient-to-b from-transparent to-black/5">
            <article className="grid place-content-center w-80 text-center gap-6">
                <picture>
                    <Image 
                ...
                <div className="space-y-2">
                    ...
                    <p className="wai-card-subtitle font-roboto font-light text-sm md:text-base flex items-center justify-center gap-1 select-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <p className="wai-card-subtitle font-roboto font-light text-sm md:text-base">
            ...
            <div className="arrow-down-text mt-16">
                <a href="#whatido" className="grid place-items-center gap-2 animate-bounce">
                    <p className="wai-card-subtitle font-roboto font-light text-lg md:text-xl text-gray-300 ">Scroll down to know more about me</p>
